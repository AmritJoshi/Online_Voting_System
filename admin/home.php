    ...
    <section class="content">
      ...
      <div class="row" >
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background-color:#98FF98;">
            <div class="inner">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background-color:#8D021F;">
            <div class="inner">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background-color:#9867C5;">
            <div class="inner">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background-color:#38B6FF;">
            <div class="inner">
              <?php
